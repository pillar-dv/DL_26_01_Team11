...
KOR_COORDS = {
    ...
    '경기도': [37.2636, 127.0286], '충청북도': [36.6358, 127.4913], '충청남도': [36.6583, 126.6736],
    '전라남도': [34.8161, 126.4629], '경상남도': [35.2383, 128.6925],
    # 풍력 지역: 한국에너지공단 풍력기 위치정보 기반 실제 단지 무게중심
    '강원도':   [37.4904, 128.7380],  # 풍력 단지 214기 평균 (태백산맥 능선)
    '경상북도': [36.4273, 129.2602],  # 풍력 단지 171기 평균 (영양·울진 동해안)
    '전라북도': [35.6968, 126.4212],  # 풍력 단지 39기 평균 (군산 해상)
    '제주도':   [33.4345, 126.6274],  # 풍력 단지 128기 평균 (제주 중앙)
    '육지':     [36.3620, 128.0856],  # 제주 제외 전국 풍력 단지 무게중심
}
